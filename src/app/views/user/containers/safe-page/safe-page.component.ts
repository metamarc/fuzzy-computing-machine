...
export class SafePageComponent implements OnInit {
  ...
  constructor(private activatedRoute: ActivatedRoute, private safeService: SafeService, private dialogService: MatDialog) {}
  ...
  ngOnInit() {
    ...
    this.safeItems$ = this.safe$.pipe(flatMap(safe => this.safeService.getItems(safe.id)));
  }
